...
class PracticeController extends Controller
{
	...
	*/
    public function getEx16() {
        ...
        #$book = \Foobooks\Book::orderBy('id','desc')->first();
	...
	*/
    ...
    /**
	* Demonstrate using the Book model without prefixing with \Foobooks\Book
	...
	*/
    public function getEx14() {
        ...
        \Foobooks\Book::where('author','LIKE','J.K. Rowling')->delete();
	...
	*/
    public function getEx13() {
        ...
        $books = \Foobooks\Book::where('author','=','Bell Hooks')->get();
        ...
        # Approach #2
        \Foobooks\Book::where('author', '=', 'Bell Hooks')->update(['author' => 'bell hooks']);
        # Resulting SQL:
        # Always:
	...
	*/
    public function getEx12() {
        ...
        $books = \Foobooks\Book::orderBy('published','desc')->get();
	...
	*/
    public function getEx11() {
        ...
        $books = \Foobooks\Book::orderBy('title','asc')->get();
	...
	*/
    public function getEx10() {
        ...
        $books = \Foobooks\Book::where('published','>',1950)->get();
	...
	*/
    public function getEx9() {
        ...
        $books = \Foobooks\Book::orderBy('id', 'desc')->get()->take(5);
	...
	*/
    public function getEx7() {
        ...
        $book = \Foobooks\Book::where('author', 'LIKE', '%Scott%')->first();
